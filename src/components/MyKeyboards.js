      ...
      <Section>
        ...
        <p>
          ...
          <PartsList>
            ...
            <li>
              <b>Switches: </b>Massdrop Holy Panda
            </li>
            <li>
              <b>Switch mods: </b>Krytox 203g0, Krytox 105 for springs
            </li>
            <li>
              <b>Case: </b>Space65 Black and Gold
            </li>
            <li>
              <b>Plate: </b>Space65 Carbon Fibre
            </li>
            <li>
              <b>Stabilizers: </b>Durock Clear
            </li>
            <li>
      ...
      <Section>
        ...
        <p>
          ...
          <PartsList>
            ...
            <li>
              <b>Switches: </b>Gateron Yellow
            </li>
            <li>
              <b>Switch mods: </b>Krytox 205g0, Krytox 105 for springs
            </li>
            <li>
              <b>Case: </b>KBDFans 5° 60% Aluminium Case - Gray
            </li>
            <li>
              <b>PCB: </b>DZ60 Rev3 RGB Underglow USB-C
            </li>
            <li>
              <b>Plate: </b>DZ60 CNC Aluminium, Layout A (2u left shift)
            </li>
            <li>
              <b>Stabilizers: </b>GMK Screw-in
            </li>
            <li>
